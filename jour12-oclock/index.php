...
<body class="text-gray-900 font-montserrat bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-emerald-50 via-oclock-bgTop to-oclock-bgBottom min-h-screen selection:bg-oclock-accent selection:text-white">
    ...
    <!-- Footer -->
    <footer class="text-center py-6 text-oclock-dial/60 font-semibold text-sm relative z-10 w-full">
        <p>Projet O'Clock &copy; 2026</p>
        <a href="https://github.com/sylvain-malbon/runtrack3/tree/main/jour12-oclock" target="_blank" class="hover:text-oclock-dial transition-colors mt-1 inline-flex items-center gap-1">
